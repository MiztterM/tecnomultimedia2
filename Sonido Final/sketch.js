...
function setup() {
  ...
  var p10 = new Particle(random(30, width-100), random(30, height-100), h10);
  var p11 = new Particle(random(30, width-100), random(30, height-100), h11);
  ...
  particles.push(
    new Particle(random(100, 400), random(200, 400), random(120, 140))
  );

  particles.push(
    new Particle(random(200, 300), random(20, 300), random(70, 120))
  );
  particles.push(
    new Particle(random(200, 400), random(200, 400), random(70, 120))
  );
}
